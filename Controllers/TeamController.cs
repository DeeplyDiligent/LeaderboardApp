...
namespace LeaderboardApp.Controllers
{
    ...
    public class TeamController : Controller
    {
        ...
        public TeamController(GhcacDbContext context, ILogger<TeamController> logger, GitHubService gitHubService, ChallengesService challengesService, ScoringService scoringService)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> AddTeam([FromBody] Team team)
        {
            ...
            return Ok(new { message = "Team created successfully (local + GitHub)!" });
        }
