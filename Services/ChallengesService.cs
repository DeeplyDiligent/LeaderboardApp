            ...
            if (await HaveAllTeamMembersCompletedChallenge(teamId, challengeId))
            {
                ...
                if (firstTeamMember != null)
                {
                    ...
                    var bonusScore = new Participantscore
                    {
                        ...
                        Activityid = 14, // Special activity ID for team bonus
                        Challengeid = challengeId,
                        Score = 50, // 50 bonus points
                        Timestamp = DateTime.UtcNow,
                        Teamid = teamId,
                    ...
                    _logger.LogInformation("Added 50 bonus points to team {TeamId} for all members completing challenge {ChallengeId}", teamId, challengeId);
                }
            }
        }
